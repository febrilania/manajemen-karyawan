                ...
                <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="status" class="form-control" required>
                            <option value="Permanent" {{ $employee->status == 'Permanent' ? 'selected' : '' }}>Permanen
                            </option>
                            <option value="Contract" {{ $employee->status == 'Contract' ? 'selected' : '' }}>Kontrak
                            </option>
                            <option value="Internship" {{ $employee->status == 'Internship' ? 'selected' : '' }}>Magang
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
